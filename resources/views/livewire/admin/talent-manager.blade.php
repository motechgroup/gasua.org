    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between space-y-4">
                <div class="space-y-3">
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-emerald-600 text-white font-bold flex items-center justify-center text-xl overflow-hidden shadow">
                            @if($t->profile_image)
                        ...
                        <div>
                            <h3 class="font-heading font-bold text-lg text-slate-900 dark:text-white">{{ $t->name }}</h3>
                    ...
                    <p class="text-xs text-slate-600 dark:text-slate-400 line-clamp-3 leading-relaxed">{{ $t->bio }}</p>
                </div>
                ...
                <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
                    ...
                    <button wire:click="delete({{ $t->id }})" onclick="confirm('Are you sure you want to delete this talent profile?') || event.stopImmediatePropagation()" class="text-rose-500 hover:text-rose-700 font-bold">
        ...
        @empty
            <div class="col-span-3 text-center py-12 text-slate-500 text-xs">
                No talents registered yet. Click "Add New Talent" to create one.
            </div>
        @endforelse
    </div>
